...
import { z } from "zod";
import { agentIntentRequestSchema } from "../src/envelope.ts";
...
export const ARTIFACTS: readonly Artifact[] = [
  {
    file: "agent-intent.v1.json",
    id: "urn:food-ordering-platform:contracts:agent-intents:request:v1",
    schema: agentIntentRequestSchema,
  },
];
